...
$(document).ready(function () {
  $(window).scroll(function () {
    ...
    if ($(window).width() <= 960) {
      if ($(this).scrollTop() < 850) { /*SE IL MOUSE ARRIVA ALLA POSIZIONE 850 IL PRIMO PARAGRAFO DA OPACITA 0(NON VISIBILE) DIVENTA VISIBILE*/
...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if ($(window).width() > 767) {
      ...
      if (scrollHeight > (galleryOffset - windowHeight + 380)) { // Se si raggiunge il div .gallery
        $('.container-image img').animate({ 'margin-left': '0', 'opacity': '1' }, 500); // Animazione dello slide-in da sinistra verso destra
        $('.container-image span').animate({ 'margin-left': '0', 'opacity': '1' }, 500);
      }
    } else if ($(window).width() <= 767) {
      var galleryOffset = $('.container-image span').offset().top;
      if (scrollHeight > (galleryOffset - windowHeight + 280)) { // Se si raggiunge il div .gallery
        $('.container-image img').animate({ 'margin-left': '0', 'opacity': '1' }, 500); // Animazione dello slide-in da sinistra verso destra
        $('.container-image span').animate({ 'margin-left': '0', 'opacity': '1' }, 500);
      }
    }
...
$(document).ready(function () {
  ...
  $('.container-image').on('click', function () {
    ...
    const $nextButton = $('<div class="gallery-next-button"><i class="fa fa-angle-right right"></i></div>');
    const $prevButton = $('<div class="gallery-prev-button"><i class="fa fa-angle-left left"></i></div>');
    const $closeButton = $('<div class="gallery-close-button"><i class="fa-solid fa-x"></i></div>');

    // Leggo l'attributo "data-images" associato alla miniatura clicata
    $('#livingRoom').attr('data-images', './photos/livingroom/living-room.jpeg, ./photos/livingroom/living-room-2.jpeg, ./photos/livingroom/living-room-3.jpeg, ./photos/livingroom/living-room-tv.jpeg');
    $('#bathRoom').attr('data-images', './photos/bathroom/bathroom-1.jpeg, ./photos/bathroom/bathroom-2.jpeg');
    $('#bedRoom').attr('data-images', './photos/bedroom/bedroom-bed.jpeg, ./photos/bedroom/bedroom-guest.jpeg, ./photos/bedroom/master-bedroom.jpeg, ./photos/bedroom/bedroom-wardrobe.jpeg');
    $('#kitchen').attr('data-images', './photos/kitchen/kitchen.jpeg, ./photos/kitchen/fridge.jpeg');
    $('#outDoor').attr('data-images', './photos/balcony&outdoor/balcony.jpeg, ./photos/balcony&outdoor/balcony-2.jpeg, ./photos/balcony&outdoor/beach.jpeg');
...
$(".preview-beach").click(function () {
  switch ($(this).index()) {
    ...
    case 1:
      ...
      break;
    case 2:
      window.open("https://www.google.com/maps/place/Spiaggia+di+Pantanagianni+Grande/@40.7543607,17.7189807,15z/data=!4m6!3m5!1s0x1346690964b8cd09:0xb9c41b900cecfcff!8m2!3d40.7488216!4d17.7223366!16s%2Fg%2F11cnb01nl5?hl=it", "_blank");
      break;
    case 3:
      window.open("https://www.google.com/maps/place/Spiaggia+di+Morgicchio/@40.7490699,17.7308056,15.75z/data=!4m10!1m2!2m1!1sSpiaggia+di+Morgicchio+santa+sabina!3m6!1s0x13466910429d2365:0xd260f1460174c197!8m2!3d40.7456557!4d17.7301781!15sCiNTcGlhZ2dpYSBkaSBNb3JnaWNjaGlvIHNhbnRhIHNhYmluYVolIiNzcGlhZ2dpYSBkaSBtb3JnaWNjaGlvIHNhbnRhIHNhYmluYZIBBWJlYWNomgEjQ2haRFNVaE5NRzluUzBWSlEwRm5TVU5WZW5NM2NraFJFQUXgAQA!16s%2Fg%2F11cncxylc3", "_blank");
      break;
    case 4:
      window.open("https://www.google.com/maps/place/Spiaggia+di+Lamaforca/@40.7668104,17.6727242,16z/data=!4m10!1m2!2m1!1sSpiaggia+di+lamaforca+santa+sabina!3m6!1s0x134669e14c556465:0x7d94d168d703ad2b!8m2!3d40.7671516!4d17.6746202!15sCiJTcGlhZ2dpYSBkaSBsYW1hZm9yY2Egc2FudGEgc2FiaW5hkgEFYmVhY2jgAQA!16s%2Fg%2F11cnb5z_lm", "_blank");
      break;
    case 5:
      window.open("https://www.google.com/maps/place/Spiaggia+di+Specchiolla/@40.7423819,17.7367545,16.25z/data=!4m6!3m5!1s0x13466919c0a953f7:0xd607ee404c9123e6!8m2!3d40.740746!4d17.7378667!16s%2Fg%2F11cnb00tk9", "_blank");
      break;
    default:
